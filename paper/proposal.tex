...
In our work, we aim to explore an approach similar to that used in FBI-LLM \cite{fbillm}, namely distillation with Quantization Aware Training. In this work, the authors first binarize all 
